function Vocode_report_PINFA_NEW
...
% define directories
DIRS.base = pwd;
DIRS.stimuli = strcat(DIRS.base,{'\pinfa_stimuli\RMS_Normalised_Vocoded_Stimuli\'});
...
dfname = [mfname(1:underscores(1)-1) '_NEW'];
