function [RSA_result, distanceMatMatch_4ch, distanceMatMatch_12ch, ...
    ...
    PINFA_simulateRSAwithinConditionTest_spearman(experimental_setup, results, modelName, showBarFig, showImageFig)
...
[distanceMatMatch_4ch, distanceMatMatch_12ch, ...
    ...
    PINFA_simulateRSAwithinConditionSetup_VowelModel_spearman(experimental_setup, results.match_word, 'match', modelName, showImageFig);
[distanceMatNeutral_4ch, distanceMatNeutral_12ch, ...
    rsNeutral_4ch, psNeutral_4ch, rsNeutral_12ch, psNeutral_12ch] = ...
    PINFA_simulateRSAwithinConditionSetup_VowelModel_spearman(experimental_setup, results.neutral_word, 'neutral', modelName, showImageFig);
