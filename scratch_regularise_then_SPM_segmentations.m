...
parfor crun = 1:nrun
    Regularised_structurals{crun} = [rawpathstem basedir{crun} '/' fullid{crun} '/' blocksin_folders{crun}{find(strcmp(blocksout{crun},'structural'))} '_reg_SPM/reg' blocksin{crun}{find(strcmp(blocksout{crun},'structural'))}];
    if crun>1 % Subject 1 was a pilot and annoyingly did not have INV1 saved
        mkdir([rawpathstem basedir{crun} '/' fullid{crun} '/' blocksin_folders{crun}{find(strcmp(blocksout{crun},'structural'))} '_reg_SPM'])
        mkdir([rawpathstem basedir{crun} '/' fullid{crun} '/' blocksin_folders{crun}{find(strcmp(blocksout{crun},'INV2'))} '_reg_SPM'])
        ...
        mkdir([inv1folder '_reg_SPM'])
        copyfile([inv1folder '/' inv1rawfile],[inv1folder '_reg_SPM/' inv1rawfile]);
        copyfile([rawpathstem basedir{crun} '/' fullid{crun} '/' blocksin_folders{crun}{find(strcmp(blocksout{crun},'structural'))} '/' blocksin{crun}{find(strcmp(blocksout{crun},'structural'))}],[rawpathstem basedir{crun} '/' fullid{crun} '/' blocksin_folders{crun}{find(strcmp(blocksout{crun},'structural'))} '_reg_SPM/' blocksin{crun}{find(strcmp(blocksout{crun},'structural'))}]);
        copyfile([rawpathstem basedir{crun} '/' fullid{crun} '/' blocksin_folders{crun}{find(strcmp(blocksout{crun},'INV2'))} '/' blocksin{crun}{find(strcmp(blocksout{crun},'INV2'))}],[rawpathstem basedir{crun} '/' fullid{crun} '/' blocksin_folders{crun}{find(strcmp(blocksout{crun},'INV2'))} '_reg_SPM/' blocksin{crun}{find(strcmp(blocksout{crun},'INV2'))}]);
        INV1_file = [inv1folder '_reg_SPM/' inv1rawfile];
        UNI_file = [rawpathstem basedir{crun} '/' fullid{crun} '/' blocksin_folders{crun}{find(strcmp(blocksout{crun},'structural'))} '_reg_SPM/' blocksin{crun}{find(strcmp(blocksout{crun},'structural'))}];
        INV2_file = [rawpathstem basedir{crun} '/' fullid{crun} '/' blocksin_folders{crun}{find(strcmp(blocksout{crun},'INV2'))} '_reg_SPM/' blocksin{crun}{find(strcmp(blocksout{crun},'INV2'))}];
        module_regularise_MP2RAGE(UNI_file,INV1_file,INV2_file,Regularised_structurals{crun})
        crop_images([cellstr([Regularised_structurals{crun}]);cellstr([rawpathstem basedir{crun} '/' fullid{crun} '/' blocksin_folders{crun}{find(strcmp(blocksout{crun},'INV2'))} '_reg_SPM/' blocksin{crun}{find(strcmp(blocksout{crun},'INV2'))}])],2);
    else
...
for crun = 1:nrun
    %     inputs{1, crun} = cellstr([rawpathstem basedir{crun} '/' fullid{crun} '/' blocksin_folders{crun}{find(strcmp(blocksout{crun},'structural'))} '_reg_SPM/p' blocksin{crun}{find(strcmp(blocksout{crun},'structural'))}]); % Cropped
    %     inputs{2, crun} = cellstr([rawpathstem basedir{crun} '/' fullid{crun} '/' blocksin_folders{crun}{find(strcmp(blocksout{crun},'INV2'))} '_reg_SPM/p' blocksin{crun}{find(strcmp(blocksout{crun},'INV2'))}]); % Cropped
    %Have to use uncropped or dimensions non idential.
    inputs{1, crun} = cellstr([rawpathstem basedir{crun} '/' fullid{crun} '/' blocksin_folders{crun}{find(strcmp(blocksout{crun},'structural'))} '_reg_SPM/reg' blocksin{crun}{find(strcmp(blocksout{crun},'structural'))}]);
    inputs{2, crun} = cellstr([rawpathstem basedir{crun} '/' fullid{crun} '/' blocksin_folders{crun}{find(strcmp(blocksout{crun},'INV2'))} '_reg_SPM/' blocksin{crun}{find(strcmp(blocksout{crun},'INV2'))}]);
    ...
    inputs{3, crun} = cellstr([rawpathstem basedir{crun} '/' fullid{crun} '/' blocksin_folders{crun}{find(strcmp(blocksout{crun},'structural'))} '_reg_SPM/reg' blocksin{crun}{find(strcmp(blocksout{crun},'structural'))}]);
    inputs{4, crun} = 'structural_reg_SPM';
    inputs{5, crun} = cellstr([preprocessedpathstem subjects{crun} '/']);
    if ~exist(inputs{5, crun}{1})
        mkdir(inputs{5, crun}{1});
    end
    inputs{6, crun} = 'structural_csf_reg_SPM';
    inputs{7, crun} = cellstr([preprocessedpathstem subjects{crun} '/']);
    inputs{8, crun} = 'c1structural_reg_SPM';
    inputs{9, crun} = cellstr([preprocessedpathstem subjects{crun} '/']);
    inputs{10, crun} = 'c2structural_reg_SPM';
...
if visualise_data
    for crun = 1:nrun
        this_scan(crun) = cellstr([rawpathstem basedir{crun} '/' fullid{crun} '/' blocksin_folders{crun}{find(strcmp(blocksout{crun},'structural'))} '_reg_SPM/reg' blocksin{crun}{find(strcmp(blocksout{crun},'structural'))}]);
        this_segmented(crun) = cellstr([rawpathstem basedir{crun} '/' fullid{crun} '/' blocksin_folders{crun}{find(strcmp(blocksout{crun},'structural'))} '_reg_SPM/c1reg' blocksin{crun}{find(strcmp(blocksout{crun},'structural'))}]);
...
module_vbm_job(group1_mrilist, group1_ages, group2_mrilist, group2_ages, [preprocessedpathstem '/reg_SPM'], segmented)