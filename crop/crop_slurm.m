function crop_slurm(vols, no_images_to_crop)
##THIS IS OBSOLETE. Use crop_images.m
...
%If cropping multiple images they must all have matching voxel size.
...
do_gunzip=1; %Gunzip the nifti files?
do_delete_sub=0;
...
% subs={
% 'sub-25382' 'ses-20160111'
%     };

% source_image='mp2rage.nii';

%Only first image is used as a coregistration source
%Amend for partitipants with SWI. Don't crop the SWI.
%imagesanat={
%    '_acq-mprage_T1w.nii'
%    };

%imagesswi={
%    '_acq-mag_part-mag_GRE.nii'
%    '_acq-phase_part-phase_GRE.nii' 
%    };
