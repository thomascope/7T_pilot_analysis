function nii_clip2bb(vols, bb, clipZ, overwrite, evenXY , clipXY)
...
%  clipXY : Do not change the x and y dimensions, only the z.
% Examples
...
if ~exist('bb','var') || isempty(bb) %bounding box not specified
    ...
    bb = [-76 -112 -64; 76 76 82]; % 20171213 increase BBOX for T1 to include all scalp for volumes calculation from T1
