...
parfor crun = 1:nrun
    ...
    GLMDir = [preprocessedpathstem subjects{crun} '/stats4_multi_3_noabsent'];
    try
...
GLMDir = [preprocessedpathstem subjects{crun} '/stats4_multi_3_noabsent']; %Template, first subject
outpath = [preprocessedpathstem '/stats4_multi_3_noabsent/searchlight/downsamp_' num2str(downsamp_ratio) filesep 'second_level']; %Results directory
