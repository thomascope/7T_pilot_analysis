...
addpath(genpath('.'))
addpath('/imaging/lh01/ownmatlab/MP2Rage_scripts/')
addpath('/imaging/lh01/ownmatlab/MP2Rage_scripts/func')
addpath('/imaging/lh01/ownmatlab/MP2Rage_scripts/nii_func')

% MP2RAGE.filenameUNI='/MP2RAGE_UNI.nii'; % standard MP2RAGE T1w image;
...
% MP2RAGE.filenameUNI='s26907-0008-00001-000224-01.nii'; % standard MP2RAGE T1w image;
% MP2RAGE.filenameINV1='s26907-0007-00001-000224-01.nii';% Inversion Time 1 MP2RAGE T1w image;
% MP2RAGE.filenameINV2='s26907-0009-00001-000224-01.nii';% Inversion Time 2 MP2RAGE T1w image;
% MP2RAGE.filenameOUT='C1_26907_MP2RAGE_denoised.nii';% image without background noise;

MP2RAGE.filenameUNI='s27270-0008-00001-000224-01.nii'; % standard MP2RAGE T1w image;
MP2RAGE.filenameINV1='s27270-0007-00001-000224-01.nii';% Inversion Time 1 MP2RAGE T1w image;
MP2RAGE.filenameINV2='s27270-0009-00001-000224-01.nii';% Inversion Time 2 MP2RAGE T1w image;
MP2RAGE.filenameOUT='C11_27270_Mem_MP2RAGE_denoised.nii';% image without background noise;
