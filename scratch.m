...
%     GLMDir = [preprocessedpathstem subjects{crun} '/stats4_multi_8_nowritten2'];
...
% 
% GLMDir = [preprocessedpathstem subjects{crun} '/stats4_multi_8_nowritten2']; %Template, first subject
