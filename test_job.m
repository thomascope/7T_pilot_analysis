%-----------------------------------------------------------------------
% Job saved on 14-Jun-2021 08:01:32 by cfg_util (rev $Rev: 6460 $)
% spm SPM - SPM12 (6906)
...
matlabbatch{1}.spm.tools.cat.estwrite.opts.tpm = {'/imaging/local/software/spm_cbu_svn/releases/spm12_latest/tpm/TPM.nii'};
matlabbatch{1}.spm.tools.cat.estwrite.opts.affreg = 'mni';
matlabbatch{1}.spm.tools.cat.estwrite.opts.biasstr = 1;
...
matlabbatch{1}.spm.tools.cat.estwrite.extopts.segmentation.setCOM = [];
...
matlabbatch{1}.spm.tools.cat.estwrite.extopts.registration.regmethod.shooting.shootingtpm = {'/imaging/local/software/spm_cbu_svn/releases/spm12_latest/toolbox/cat12/templates_volumes/Template_0_IXI555_MNI152_GS.nii'};
...
matlabbatch{1}.spm.tools.cat.estwrite.extopts.registration.bb = [];
...
matlabbatch{1}.spm.tools.cat.estwrite.extopts.surface.SRP = [];
